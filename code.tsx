...
figma.ui.onmessage = (message) => {
  ...
  switch (message.dir) {
    case "up": return avatar.y -= 8;
    case "down": return avatar.y += 8;
  }
...
function Widget() {
  ...
  const openControlPanel = () => new Promise((resolve) => {
  ...
  return (
    <Rectangle onClick={openControlPanel} width={40} height={40} x={pos[0]} y={pos[1]} fill="#333333" />
  )
}
